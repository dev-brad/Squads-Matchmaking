...
describe("POST routes", function() {
  ...
  it("should get /signup when bad Fortnite username", function(done) {
    this.timeout(5000);
    this.slow(4000);
    ...
    let badFortniteName = {
      ...
      squadsName: 'frodo9',
      apexName: '',
      fortniteName: 'ayuxkawdcgoawucvgkadjhvja',
      password: 'trolls'
    }

    newUser
    .post('/signup')
    .send(badFortniteName)
    .expect(200)
    .set('Content-Type', 'application/x-www-form-urlencoded')
    .end(function(err, res){
      if (err) {
  ...
  it("should get /signup when bad Apex Legends username", function(done) {
    this.timeout(5000);
    this.slow(4000);
    ...
    let badApexName = {
      ...
      bdate: '1900-04-01',
      squadsName: 'frodo9',
      apexName: 'kxjanxkahsbclahcbls b',
      fortniteName: '',
      password: 'trolls'
    }
